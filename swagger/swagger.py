...
from flask_restful_swagger import swagger as swag
import sqlite3
...
def protected(username):
    ...
    definition:
      ...
      properties:
        message:
          type: string
          description: A message indicating successful access to the protected resource.
    """
